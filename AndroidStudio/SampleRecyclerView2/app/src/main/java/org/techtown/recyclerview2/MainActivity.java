...
import org.techtown.recyclerview2.OnPersonItemClickListener;
import org.techtown.recyclerview2.R;

public class MainActivity extends AppCompatActivity {
    RecyclerView recyclerView;
    org.techtown.recyclerview2.PersonAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new org.techtown.recyclerview2.PersonAdapter();
        ...
        adapter.setOnItemClickListener(new OnPersonItemClickListener() {
            @Override
            public void onItemClick(org.techtown.recyclerview2.PersonAdapter.ViewHolder holder, View view, int position) {
